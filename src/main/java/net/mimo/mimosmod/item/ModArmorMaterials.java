...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    MYSTELITE("mystelite", 40, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
    ...
    }), 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> Ingredient.of(ModItems.MYSTELITE.get())
    );
    ;
    ...
    public String getName() {
        return MimosMod.MOD_ID + ":" + this.name;
    }
